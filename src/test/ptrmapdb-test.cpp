...
TEST(ptrmapdb_test, single_at_start) {
    ptrmap_kmer_db db(5);
...
TEST(ptrmapdb_test, multi_at_start) {
    ptrmap_kmer_db db(5);
...
TEST(ptrmapdb_test, single_at_end) {
    ptrmap_kmer_db db(5);
...
TEST(ptrmapdb_test, multi_at_end) {
    ptrmap_kmer_db db(5);

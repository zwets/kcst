...
TEST(ptrvecdb_test, single_at_start) {
    ptrvec_kmer_db db(5);
...
TEST(ptrvecdb_test, multi_at_start) {
    ptrvec_kmer_db db(5);
...
TEST(ptrvecdb_test, single_at_end) {
    ptrvec_kmer_db db(5);
...
TEST(ptrvecdb_test, multi_at_end) {
    ptrvec_kmer_db db(5);
